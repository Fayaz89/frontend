...
const Footer = () => {
  return (
    <>
      <footer className="text-center text-sm text-gray-500 bg-green-700 py-10">
        <p className='text-white font-serif text-2xl'>
          Need to talk to us directly? 
          <li className="text-red-700 hover:text-indigo-500 list-none">Contact us</li>
        </p>
        <p className='text-white text-lg mt-4'>Contact With Us</p>
        <div className="mt-4 flex justify-center space-x-4 my-8">
          <li className="text-gray-400 my-6 mx-4 hover:text-gray-500">
          ...
          <li className="text-gray-400 my-6 mx-6 hover:text-gray-500">
